      ...
      {open && (
        <div className="fixed inset-0 bg-white z-50 md:hidden">
          ...
          <div className="flex items-center justify-between px-6 py-4 border-b">
            <img src={assets.logo} alt="DailyFit" className="h-10" />
          ...
          <ul className="flex flex-col gap-4 px-6 py-8 text-lg">
            <NavLink to="/" className={mobileLinkStyle} onClick={() => setOpen(false)}>HOME</NavLink>
            <NavLink to="/collection" className={mobileLinkStyle} onClick={() => setOpen(false)}>COLLECTION</NavLink>
            <NavLink to="/about" className={mobileLinkStyle} onClick={() => setOpen(false)}>ABOUT</NavLink>
            <NavLink to="/contact" className={mobileLinkStyle} onClick={() => setOpen(false)}>CONTACT</NavLink>
          </ul>
        </div>
      )}
    </nav>
